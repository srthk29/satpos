...
std::vector<std::string_view> split_lines_memchr(std::string_view str) {
    ...
    while (start < end && (next_nl = static_cast<const char*>(std::memchr(start, '\n', std::size_t(end - start))))) {
